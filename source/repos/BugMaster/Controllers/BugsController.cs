...
namespace BugMaster.Controllers
{
    ...
    public class BugsController : ControllerBase
    {
        ...
        // GET: api/bugs/TotalDefects
        [HttpGet("TotalBugs")]
        public int GetTotalBugs()
        {
          return _context.Defect.ToList().Count;
        }

        // GET: api/bugs/TotalBugsByStatusID/1
        [HttpGet("TotalBugsByStatusID/{StatusID}")]
        public int GetTotalBugsByStatusID(int StatusId)
        {
          var BugCount = _context.Defect.Where(x => x.CurrentStatusId == StatusId).ToList().Count;
          return BugCount;
        }

        // GET: api/bugs/TotalBugsByStatusID/1
        [HttpGet("TotalBugsByAssignedToID/{UserID}")]
        public int TotalBugsByAssignedToId([FromRoute] string assignedToId)
        {
          int BugCount = _context.Defect.Where(x => x.AssignToId == assignedToId).ToList().Count;
          return BugCount;
        }
