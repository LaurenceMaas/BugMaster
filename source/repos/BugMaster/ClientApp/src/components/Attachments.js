                    ...
                    <Col sm="12">
                        <FormGroup>
                            ...
                            <div className="container-name">
                                ...
                                <button name="AddAttachment" className="btn btn-primary" style={AddattachmentStyling} onClick={(e) => { this.props.onAddAttachment(e, "AttachmentList", this.props.attachmentfiles) }}>Add Attachments</button>
                            </div>
                        </FormGroup>
