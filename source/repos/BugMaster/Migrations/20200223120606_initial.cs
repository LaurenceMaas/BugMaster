        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditTrail_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AuditTrail_AspNetUsers_UpdateById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StepsToRecreate = table.Column<string>(nullable: true),
                    LoggedbyId = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Defect_Status_CurrentStatusId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Defect_Severity_SeverityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attachment_DefectId",
                table: "Attachment",
                column: "DefectId");

            migrationBuilder.CreateIndex(
                name: "IX_AuditTrail_CreatedById",
                table: "AuditTrail",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_AuditTrail_UpdateById",
                table: "AuditTrail",
                column: "UpdateById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Defect_CurrentStatusId",
                table: "Defect",
